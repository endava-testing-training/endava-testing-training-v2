                       ...
                       <main className="page-content" aria-label="Content">
                           <div className="wrapper">
                               <div className="home">
                                    ...
                                    <p></p>
                                    <p className="communityleads">Community lead : Gisela Vivas - Carla Passaro</p>
                                    ...
                                    <p></p>
                                    <p className="communityleads">Community lead: Martín zapata - Maria Alejandra Usart </p>
                                    <hr />
                                    ...
                                    <p></p>
                                    <p className="communityleads">Community lead: Adelquis Trinidad - Guillermo Cejas</p>
                                </div>
                            </div>
                        </main>
                    </div>
